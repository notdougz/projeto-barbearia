...
class FluxoCompletoAgendamentoTest(TestCase):
    ...
    def setUp(self):
        ...
        self.cliente = Cliente.objects.create(
            nome="João Silva", telefone="11999999999", endereco="Rua das Flores, 123"
        )
...
class FluxoClienteServicoTest(TestCase):
    ...
    def test_criacao_cliente_e_agendamento_sequencial(self):
        ...
        servico = Servico.objects.create(
            nome="Barba Completa", duracao=20, preco=Decimal("15.00")
        )
    ...
    def test_edicao_servico_e_impacto_agendamentos(self):
        ...
        # Criar cliente
        cliente = Cliente.objects.create(nome="Carla Mendes", telefone="11555555555")
        ...
        response = self.client.post(
            reverse("editar_servico", args=[servico.pk]), servico_data
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_desativacao_servico_e_formularios(self):
        ...
        # Criar serviço ativo
        servico = Servico.objects.create(
            nome="Escova Progressiva", duracao=120, preco=Decimal("80.00"), ativo=True
        )
...
class FluxoStatusAgendamentoTest(TestCase):
    ...
    def setUp(self):
        ...
        self.cliente = Cliente.objects.create(
            nome="Roberto Silva", telefone="11444444444"
        )

        self.servico = Servico.objects.create(
            nome="Corte + Barba", duracao=45, preco=Decimal("40.00")
        )
